    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto p-4 pb-28 space-y-6">
        ...
        <div className="flex gap-2 px-0 py-1 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
          {[
            { icon: '🍽️', label: 'Nutrição', anchor: 'sec-nutricao' },
            { icon: '💧', label: 'Água',     anchor: 'sec-agua' },
            { icon: '💪', label: 'Treino',   anchor: 'sec-treino' },
            { icon: '😴', label: 'Sono',     anchor: 'sec-sono' },
        ...
        {/* Banner perfil incompleto — imediatamente após Quick Nav */}
        {!isProfileComplete && (
          <>
            <button
            ...
            <p className="text-muted-foreground text-sm text-center py-4">
              Complete seu perfil para ver suas metas personalizadas de nutrição, água e treino.
            </p>
          </>
        )}
